...
// 포인터로 사용하기 위해서 virtual을 사용하는 것인지?
// 다형성을 구현하기 위해 virtual을 사용하는 것인지?
// 자식 클래스에서 부모 클래스의 함수를 호출 + 추가 내용으로 구현하는 것은 다형성이 아닌지?

// 복사 생성자 : virtual은 복사를 하는데, 초기화 멤버 변수는 그대로 유지
// why?