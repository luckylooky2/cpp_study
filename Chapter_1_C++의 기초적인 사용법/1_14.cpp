// 1.14 전처리기(preprocessor)와의 첫 만남
...
int	main()
{
	std::cout << MY_NUMBER << std::endl;			// 9
	std::cout << MY_WORD << std::endl;				// Hello World
	std::cout << MAX(2 + 3, 2) << std::endl;		// 5
	// 역시 namespace std
	// MACRO : _LIBCPP_BEGIN_NAMESPACE_STD
	std::cout << std::max(2 + 3, 2) << std::endl;	// 5
#ifdef MAC_OS
	std::cout << "MacOS " << std::endl;				// MacOS
#endif
#ifndef MAC_OS
	std::cout << "Windows " << std::endl;
#endif
	printIfWindows();								// MacOS
